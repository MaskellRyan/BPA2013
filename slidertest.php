		...
		<figure data-toggle="collapse" data-target="#drawer1"> <!-- EACH DRAWER MUST DATA-TARGET THE INDIVIDUAL ARTICLE ID -->
			...
			<div id="slider1" class='swipe'>
			  <div class='swipe-wrap'>
			    <div>
			    	<h1><a href="#">Source 1</a><span> by Flickr user <a href="#">Ryan Maskell</a></span></h1>
					<img src="_/content/img/history/indust_train.jpg">
			    </div>
			    <div>
			    	<h1><a href="#">Source Two!</a><span> by Foursquare user <a href="#">Ashley Chaffin</a></span></h1>
					<img src="_/content/img/history/indust_workers.jpg">
			    </div>
			    <div>
			    	<h1><a href="#">The Third Source</a><span> by Flickr user <a href="#">Awesomesauce</a></span></h1>
					<img src="_/content/img/history/indust_car.jpg">
			    </div>
			    <div>
			    	<h1><a href="#">FOUR: A source</a><span> by Instagram user <a href="#">Rachael Morgan</a></span></h1>
